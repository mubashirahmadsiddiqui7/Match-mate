...
export default function addFinalProduct() {
  ...
  return (
    <ScrollView>
      ...
      <View style={styles.card2}>
        <Text style={{ fontWeight: 'bold' }}>Enter Lot ID and quantities in the form of weight</Text>
        {lots.map((lot, index) => (
          <View style={styles.inputContainer}>
            ...
            />
            <Text>Enter weight sending:</Text>
            <TextInput
              style={{
                backgroundColor: '#fff',
                padding: 10,
